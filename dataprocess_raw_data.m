...
clear all;
%load data files
data15 = readtable('Fangraphs Leaderboard15.xlsx');
data16 = readtable('Fangraphs Leaderboard16.xlsx');
data17 = readtable('Fangraphs Leaderboard17.xlsx');
data18 = readtable('Fangraphs Leaderboard18.xlsx');
data19 = readtable('Fangraphs Leaderboard19.xlsx');
data20 = readtable('Fangraphs Leaderboard20.xlsx');
...
X15 = organized_2015(:, [3:12 14:end-1]);
y15 = organized_2015(:, 13);
X16 = organized_2016(:, [3:12 14:end-1]);
y16 = organized_2016(:, 13);
...
X16 = organized_2016(:, [3:12 14:end-1]);
y16 = organized_2016(:, 13);
X17 = organized_2017(:, [3:12 14:end-1]);
y17 = organized_2017(:, 13);
...
X17 = organized_2017(:, [3:12 14:end-1]);
y17 = organized_2017(:, 13);
X18 = organized_2018(:, [3:12 14:end-1]);
y18 = organized_2018(:, 13);
...
X19 = organized_2019(:, [3:12 14:end-1]);
y19 = organized_2019(:, 13);
X20 = organized_2020(:, [3:12 14:end-1]);
y20 = organized_2020(:, 13);
X19_20 = cell2mat(X20) - cell2mat(X19);
y19_20 = cell2mat(y20) - cell2mat(y19);

%completed training/validation/test data
%15-18 (training)
Xtrain_raw = [X15_16; X16_17; X17_18];
%Xtrain = Xtrain(:, 2:11);
ytrain_raw = [y15_16; y16_17; y17_18];
%18-19 (validation)
Xval_raw = X18_19;
%Xval = Xval(:, 2:11);
yval_raw = y18_19;
